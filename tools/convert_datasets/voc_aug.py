...
def parse_args():
    ...
    parser.add_argument('--devkit_path', default='../../VOCtrainval_11-May-2012/VOCdevkit', help='pascal voc devkit path')
    parser.add_argument('--aug_path', default='../VOCaug', help='pascal voc aug path')
